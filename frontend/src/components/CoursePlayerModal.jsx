              ...
              <div className="grid min-h-0 flex-1 grid-cols-1 overflow-y-auto lg:grid-cols-[1fr_21rem]">
                ...
                <aside className="border-t border-white/10 p-4 sm:p-5 lg:border-l lg:border-t-0">
                  ...
                  <button
                    ...
                    className={`mt-4 w-full rounded-lg border py-2.5 text-sm font-semibold transition-all duration-200 disabled:cursor-not-allowed ${
                      completed
                  ...
                  {completed && (
                    <button
                      ...
                      className="mt-2 w-full rounded-lg border border-accent-400/25 bg-accent-400/10 py-2 text-sm font-semibold text-accent-100 transition-all hover:bg-accent-400/20"
                    >
                      🎓 View Certificate
                    </button>
                  )}
